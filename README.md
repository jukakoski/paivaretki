...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/tk1mmpv0/settings/api) and create a token with read rights.
...
## Guide
https://www.sanity.io/guides/the-blog-template